...
function CalendarInit()				///Create panel
{
	...
	htmlAll=htmlAll+htmloMonth+htmloYear+htmloDayTable+"</div>";
...
function CalendarMonthChange(oInstance)				/// Month Change
{
	...
	if(sDay>CalendarGetMaxDay(parseInt(sYear),parseInt(sMonth)))
	sDay=CalendarGetMaxDay(parseInt(sYear),parseInt(sMonth));
	newDate=new Date(sYear,sMonth,sDay);
	oInstance.Refresh(newDate);	
}
