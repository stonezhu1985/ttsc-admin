...
//	email  : pinotoy@yahoo.com
	...
	var language = 'zh';	// Default Language: zh- chinese en - english ; es - spanish; de - german
	...
	var scrollLeftMessage = {
		zh : 'Click to scroll to previous month. Hold mouse button to scroll automatically.',
		en : 'Click to scroll to previous month. Hold mouse button to scroll automatically.',
		es : 'Presione para pasar al mes anterior. Deje presionado para pasar varios meses.',
		de : 'Klicken um zum vorigen Monat zu gelangen. Gedr點kt halten, um automatisch weiter zu scrollen.'
	};
	var scrollRightMessage = {
		zh : 'Click to scroll to previous month. Hold mouse button to scroll automatically.',
		en : 'Click to scroll to next month. Hold mouse button to scroll automatically.',
		es : 'Presione para pasar al siguiente mes. Deje presionado para pasar varios meses.',
		de : 'Klicken um zum n鋍hsten Monat zu gelangen. Gedr點kt halten, um automatisch weiter zu scrollen.'
	};
	var selectMonthMessage = {
		zh : '点击要选择的月份',
		en : 'Click to select a month.',
		es : 'Presione para seleccionar un mes',
		de : 'Klicken um Monat auszuw鋒len'
	};
	var selectYearMessage = {
		zh : '点击要选择的年',
		en : 'Click to select a year.',
		es : 'Presione para seleccionar un a駉',
		de : 'Klicken um Jahr auszuw鋒len'
	};
	var selectDateMessage = {		// do not replace [date], it will be replaced by date.
		zh : '选择 [date]',
		en : 'Select [date] as date.',
		es : 'Seleccione [date] como fecha',
		de : 'W鋒le [date] als Datum.'
	};
	var	monthName = {
		zh : new Array('一月','二月','三月','四月','五月','六月','七月','八月','九月','十月','十一月','十二月'),
		en : new Array('January','February','March','April','May','June','July','August','September','October','November','December'),
		es : new Array('Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre'),
		de : new Array('Januar','Februar','M鋜z','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember')
	};
	var	monthName2 = {
		zh : new Array('JAN','FEB','MAR','APR','MAY','JUN','JUL','AUG','SEP','OCT','NOV','DEC'),
	...
	if (startAt==0) {
		...
		dayName = {
			zh : new Array('Mon','Tue','Wed','Thu','Fri','Sat','Sun'),
